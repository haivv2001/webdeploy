...
if(isset($_POST['login']))
{
    ...
    if(mysqli_num_rows($result)>0){
        ...
        $_SESSION['username'] = $row['name'];
            header("Location: ./xuatdulieu.php");
        } 
        else {
          echo"sai mat khau";
        }
...
<div class="hai">
    <div>
        <!-- <img class="img_1" width="300px" height="300px" src="image/vân tay.png" > -->
    ...
    <div class="container">
        ...
        <form action="login.php" method="post">
            ...
            <label style="display: inline-block; font-size:15 ;color: #000000;">remember</label>
            <a  href="./forgot.php" style="display: inline-block;margin-left: 150px; text-decoration: none;color: #000000;">Forgot password ?</a>
